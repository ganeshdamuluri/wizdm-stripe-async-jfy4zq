import { OnDestroy, ElementRef, Input, Output, EventEmitter } from '@angular/core';
...
export abstract class StripeElementDirective<T extends StripeElementType> implements OnDestroy {
