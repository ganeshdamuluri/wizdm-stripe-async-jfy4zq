...
import { StripeElementDirective, computeBaseStyle } from '../element.directive';
...
@Component({
  ...
  template: '',
  providers: [
    { provide: StripeElementDirective, useExisting: forwardRef(() => StripeCardElement) }
  ]
})
export class StripeCardElement extends StripeElementDirective<'card'> implements  OnInit, OnChanges {
